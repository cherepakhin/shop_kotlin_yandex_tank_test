...
<span style="color:green">Зеленая линия</span> - <b>"стреляющая" машина"</b> 192.168.1.57 (отражена на графике просто для примера)

<span style="color:yellow">Желтая линия</span> - <b>"расстреливаемая"</b> машина 192.168.1.20:8980.
